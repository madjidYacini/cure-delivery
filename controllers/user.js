    ...
    console.log(user.password) 
       ...
       bcrypt.compare( req.body.password, user.password,(err, result) => { 
         ...
         req.checkBody("newPassword", "password is required").notEmpty(); 
          req.checkBody( "newPassword", "password should have at least , one uppercase , lowercase and a number and at least 8 chars" ).matches(passwordRegex); 
 
          req.checkBody("newPasswordConfirm", "newPasswordConfirm is required").notEmpty(); 
          req .checkBody("newPasswordConfirm", "passwords do not match").equals(newPassword); 
           let errors = req.validationErrors(); 
